...
# Assignment: Peer-graded Assignment: Course Project 1.3
...
# Construct Energy sub metering plot with proper labels and colors
with(GAP, {
...
# Copy Energy sub metering plot to png file with proper dimensions
dev.copy(png,"plot3.png", width=480, height=480)

# Terminate png device to close device and save plot3.png
dev.off()
