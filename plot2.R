...
# Assignment: Peer-graded Assignment: Course Project 1.2
...
# Construct Global Active Power plot with proper labels and colors
plot(GAP$Global_active_power~GAP$DT, type="l"
     , ylab="Global Active Power (kilowatts)", xlab="")

# Copy Global Active Power plot to png file with proper dimensions
dev.copy(png,"plot2.png", width=480, height=480)

# Terminate png device to close device and save plot2.png
dev.off()
