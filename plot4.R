...
# Assignment: Peer-graded Assignment: Course Project 1.4
...
# Construct two by two matrix of plots with proper labels and colors
...
# Copy two by two matrix of plots to png file with proper dimensions
dev.copy(png,"plot4.png", width=480, height=480)

# Terminate png device to close device and save plot4.png
dev.off()
